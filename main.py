...
if plotting:
	...
	plt.style.use('stylesheets/contour.mplstyle')
	plot.plot_all_seaice_trends(resolutions, temporal_resolution, temporal_decomposition, detrend, seaice_source = seaice_source)

	plt.style.use('stylesheets/contour.mplstyle')
	plot.plot_all_subplot_trends(resolutions, temporal_resolution, temporal_decomposition, detrend, seaice_source = seaice_source)

	plt.style.use('stylesheets/timeseries.mplstyle')
	plot.predict_seaice(resolutions, temporal_resolution, temporal_decomposition, detrend, seaice_source = seaice_source)